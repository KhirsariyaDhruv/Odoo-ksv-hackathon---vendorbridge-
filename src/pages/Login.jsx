        ...
        <div className="glass-panel rounded-[32px] p-8 md:p-10 relative overflow-hidden">
          ...
          <form className="space-y-stack-md relative z-10">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input className="w-full bg-[#080808] border border-white/10 focus:border-primary focus:shadow-[0_0_15px_rgba(108,99,255,0.2)] outline-none rounded-xl py-3 pl-12 pr-4 text-on-surface font-body-md placeholder:text-on-surface-variant/50 transition-all duration-300" id="username" name="username" placeholder="Enter your credentials" required type="text" />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input className="w-full bg-[#080808] border border-white/10 focus:border-primary focus:shadow-[0_0_15px_rgba(108,99,255,0.2)] outline-none rounded-xl py-3 pl-12 pr-12 text-on-surface font-body-md placeholder:text-on-surface-variant/50 transition-all duration-300" id="password" name="password" placeholder="••••••••" required type="password" />
            ...
            {/* Submit Button */}
            <Link to="/" className="w-full py-4 rounded-full font-body-md text-body-md font-semibold text-white bg-[#6C63FF] hover:bg-[#5b54d6] hover:shadow-[0_0_20px_rgba(108,99,255,0.3)] transition-all duration-300 mt-stack-md flex justify-center items-center gap-2 block text-center">
              Login to Terminal
              <span className="material-symbols-outlined text-[20px]">
                arrow_forward
              </span>
          ...
          <div className="mt-stack-lg text-center relative z-10">
            <p className="font-body-sm text-body-sm text-on-surface-variant">
              Don't have access? 
              <a className="text-primary font-semibold hover:text-primary-container transition-colors ml-1 border-b border-primary/30 hover:border-primary" href="#">
