export function CreateRFQ() {
  return (
    <div className="w-full max-w-4xl max-w-[800px] mx-auto mt-4">
      {/* Header */}
      ...
      <div className="mb-stack-lg relative">
        ...
        <div className="absolute top-1/2 left-0 w-1/3 h-0.5 bg-primary -translate-y-1/2 z-0 rounded-full shadow-[0_0_20px_rgba(135,129,255,0.15)]"></div>
      ...
      {/* Form Container */}
      <div className="glass-panel rounded-xl p-stack-md relative overflow-hidden">
        ...
        <form className="space-y-stack-md relative z-10">
          <div className="space-y-stack-sm">
            ...
            <input className="w-full bg-[#080808] border border-white/10 focus:border-primary focus:shadow-[0_0_10px_rgba(135,129,255,0.2)] outline-none rounded-lg py-3 px-4 text-body-md font-body-md text-on-surface placeholder-on-surface-variant/30 transition-all duration-200" id="rfq-title" placeholder="e.g., Q3 Office Furniture Refresh" type="text" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-stack-md">
            <div className="space-y-stack-sm">
              ...
              <div className="relative">
                <select className="w-full bg-[#080808] border border-white/10 focus:border-primary focus:shadow-[0_0_10px_rgba(135,129,255,0.2)] outline-none rounded-lg py-3 pl-4 pr-10 text-body-md font-body-md text-on-surface appearance-none cursor-pointer transition-all duration-200" id="category">
            ...
            <div className="space-y-stack-sm">
              ...
              <div className="relative">
                <input className="w-full bg-[#080808] border border-white/10 focus:border-primary focus:shadow-[0_0_10px_rgba(135,129,255,0.2)] outline-none rounded-lg py-3 px-4 text-body-md font-body-md text-on-surface transition-all duration-200 [&::-webkit-calendar-picker-indicator]:filter [&::-webkit-calendar-picker-indicator]:invert [&::-webkit-calendar-picker-indicator]:opacity-50 hover:[&::-webkit-calendar-picker-indicator]:opacity-100 cursor-pointer" id="deadline" type="date" />
              </div>
            </div>
          </div>
          <div className="space-y-stack-sm">
            ...
            <textarea className="w-full bg-[#080808] border border-white/10 focus:border-primary focus:shadow-[0_0_10px_rgba(135,129,255,0.2)] outline-none rounded-lg py-3 px-4 text-body-md font-body-md text-on-surface placeholder-on-surface-variant/30 resize-none transition-all duration-200" id="description" placeholder="Provide detailed requirements, specifications, or context for this request..." rows="4"></textarea>
          </div>
          <div className="pt-stack-sm flex justify-end gap-4 border-t border-white/5 mt-stack-md">
            ...
            <button className="px-6 py-2.5 rounded-full font-body-md text-body-md text-on-primary bg-primary hover:bg-primary-fixed-dim transition-colors shadow-[0_0_20px_rgba(135,129,255,0.15)] flex items-center gap-2 group" type="button">
              Next Step
